...
const PreviewButtonGroup = ({ config, document: document2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Wrapper, { direction: "column", gap: 2, children: [
    /* @__PURE__ */ jsxRuntime.jsx(PreviewButton, { url, isDraft: !isPublished }),
    /* @__PURE__ */ jsxRuntime.jsx(CopyButton, { url, isDraft: !isPublished })
  ] });
};
const Controls = () => {
  const context = admin.unstable_useContentManagerContext();
  const entity = admin.unstable_useDocument({
    documentId: context.id,
    model: context.model,
    collectionType: context.collectionType
  });
  const settings = useSettings();
  if (!settings || !Array.isArray(settings.contentTypes)) return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
  ...
  if (!contentType) return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
  if (!entity || entity.isLoading || !entity.document) return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
  return /* @__PURE__ */ jsxRuntime.jsx(PreviewButtonGroup, { config: contentType, document: entity.document });
};
const index = {
  register(app) {
    app.registerPlugin({
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("../_chunks/en-BMewMGGn.js")), "./translations/es.json": () => Promise.resolve().then(() => require("../_chunks/es-C-RTdY6v.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("../_chunks/fr-DkmZmDed.js")), "./translations/ja.json": () => Promise.resolve().then(() => require("../_chunks/ja-Cbt5BGiT.js")), "./translations/ru.json": () => Promise.resolve().then(() => require("../_chunks/ru-Dx8-MLbH.js")), "./translations/tr.json": () => Promise.resolve().then(() => require("../_chunks/tr-CdNtZYRt.js")) }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
